...
export default function Footer() {
  return (
    // <footer className="min-h-[70px] flex justify-center items-center border-t-2">
    //   Footer
    // </footer>

    <>
      {/* // */}
      <footer className="bg-gradient-to-t from-primary/30 to-secondary/5">
        <div className=" px-4 pb-8 pt-16 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-md">
            <strong className="block text-center text-xl font-bold sm:text-3xl">
              Want us to email you with the latest Offers & Updates?
            </strong>
            ...
            <form className="mt-6">
              <div className="relative max-w-lg">
                ...
                <button className="absolute end-1 top-1/2 -translate-y-1/2 rounded-full bg-primary px-5 py-3 text-sm font-medium transition hover:bg-blue-700">
                  Subscribe
                </button>
              </div>
            </form>
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 lg:grid-cols-2 lg:gap-32">
