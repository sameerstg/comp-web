...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 w-[100%] z-50  flex min-h-[70px] h-[70px] bg-transparent items-center gap-8 px-4 sm:px-6 lg:px-8">
            ...
            {navItems.map((item) => (
              <li key={item.id}>
                <Link
                  ...
                  className={`${
                    pathname === item.url
                      ? "bg-primary  px-3 py-1 rounded text-white"
                      : ""
                  }`}
                >
                  {item.name}
